...
item = {
    ...
    [
        990,
        4,
        '加工器是免费的，但是便宜没好货......因此这个道具只能用一次。\n使用加工器可以花费一段时间将你的刺儿加工成一个精美的小饰品，小饰品可以卖到一个不菲的价钱。'
    ],
    '刺儿饰品':
    [
        1088, #这个是平均值
...
today_item = {'刺儿加工器': 100, '指南针': 1000, '神秘碎片': 1000, '时间秒表': 50, '胡萝卜': 50, '招财猫': 100, '一次性小手枪': 100, '弹弓': 100, 'kid充能器': 1000, 'kid提取器': 50,'时间提取器':1000,'赌徒之眼':200}